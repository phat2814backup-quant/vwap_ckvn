...
if selected_stock:
    ...
    if df.empty:
        ...
        if tf_code in ["1H", "15m", "5m"]:
            rbreaks.append(dict(bounds=[14.75, 9.0], pattern="hour"))      # Đêm: 15h00 đến 08h30 sáng hôm sau
            rbreaks.append(dict(bounds=[11.5, 13.0], pattern="hour"))   # Trưa: 11h36 đến 12h54 trưa cùng ngày
